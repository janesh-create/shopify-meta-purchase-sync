...
function isQualifiedMetaTraffic(adClickData, config) {
  ...
  // Either signal is enough — an order counts as qualified Meta traffic
  // if it matches the utm_source allow-list OR the utm_content pattern
  // list. Using AND here would require perfectly consistent tagging on
  // every single campaign, which isn't realistic in practice.
